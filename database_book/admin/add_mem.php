<?php
include('../condb.php');
$dep  ="SELECT * FROM department" or die("Error:" . mysqli_error()); 
//ประกาศตัวแปร sqli
...
<html lang="en">
  ...
  <body>
   ...
   <div class="container">
     <div class="card">
        <div class="card-body">
        <h1 class="text-center bg-info text-white">เพิ่มข้อมูลสมาชิก</h1>
        
        
    <form action="../check/insert_mem.php" method="post" name="form1" id="form1">
      <br>
  ...
  <div class="row">
    ...
    <label class="small mb-1" for="inputPassword">ชื่อ</label>
       <input class="form-control" id="name_mem" name="name_mem"  type="text"  required />
    </div>
    <div class="col">
    <label class="small mb-1" for="inputPassword">นามสกุล</label>
    <input class="form-control" id="lname_mem" name="lname_mem"  type="text" required />
    </div>
  </div>
  ...
  <div class="row">
    ...
    <input class="form-control" id="phone_num" name="phone_num" pattern="[0-9]+" type="tel" maxlength="10" minlength="10"  />
    </div>
  </div>
  <br>
